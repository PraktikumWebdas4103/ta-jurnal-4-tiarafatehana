...
<body style="font-family:mimich;background-color: #a6d183;">
	...
	<table>
		...
		<tr>
			<td>
				<input type="checkbox" name="hoby[]" value="Acting">Berenang <br>
				<input type="checkbox" name="hoby[]" value="Backpacking">Mendengarkan Musik 
			</td>
			<td>
				<input type="checkbox" name="hoby[]" value="Badminton">Badminton<br>
				<input type="checkbox" name="hoby[]" value="Football">Membaca Novel
			</td>
			<td>
				<input type="checkbox" name="hoby[]" value="Swimming">Makan<br>
				<input type="checkbox" name="hoby[]" value="Ballet">Tidur
			</td>
			<td>
				<input type="checkbox" name="hoby[]" value="Dancing">Fangirling<br>
				<input type="checkbox" name="hoby[]" value="Music">Dance
			</td>
			<td>
				<input type="checkbox" name="hoby[]" value="Programming">Menulis<br>
